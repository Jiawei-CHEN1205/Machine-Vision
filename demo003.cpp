...
void action()
{
  ...
  OpenFramegrabber("DirectShow", 1, 1, 0, 0, 0, 0, "default", 8, "rgb", -1, "false", 
      "default", "[0] Integrated Webcam", 0, -1, &hv_AcqHandle);
  SetFramegrabberParam(hv_AcqHandle, "brightness", 48);
  SetFramegrabberParam(hv_AcqHandle, "saturation", 74);
  SetFramegrabberParam(hv_AcqHandle, "video_gain", 2);
